...
<div class="checkbox-container {className}" class:muted={muted} class:ghost={ghost}>
    <input 
        type="checkbox"
        id={uniqueId}
    ...
    <label for={uniqueId} class="checkbox-label">
        <div class="checkbox-box" class:checked={checked} class:mixed={mixed} class:disabled={disabled}>
            {#if mixed}
